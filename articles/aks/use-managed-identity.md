...
>
> Permission grants to cluster Managed Service Identity used by Azure Cloud provider may take up 60 minutes to populate. For details see [Azure token on 403](https://github.com/kubernetes/kubernetes/issues/90351).
